...
#ifndef KLFITTER_CUSTOMPERMUTATIONS_H_
#define KLFITTER_CUSTOMPERMUTATIONS_H_
...
namespace KLFitter {
/**
  * \class KLFitter::CustomPermutations
  ...
  */
class CustomPermutations final {
 public:
  ...
  /**
    ...
    */
  explicit CustomPermutations(const CustomPermutations& o);
  ...
  /**
    ...
    */
  CustomPermutations& operator=(const CustomPermutations& obj);
...
//  std::vector<std::vector<int> > Get_M_from_N(unsigned int N, unsigned int M, unsigned int start = 0);
  ...
  nlohmann::json fJsonPermutations;
