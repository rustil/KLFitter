...
#ifndef KLFITTER_LIKELIHOODFOURTOPLEPTONJETS_H
#define KLFITTER_LIKELIHOODFOURTOPLEPTONJETS_H
...
/**
 * A class implementing a likelihood for the Four-top-quark lepton+jets channel.
 */
    class LikelihoodFourTopLeptonJets : public LikelihoodBase {
    public:
        ...
        enum Parameters {
            parBhad1E,   ///< Energy of the hadronic b quark 1
            parBhad2E,   ///< Energy of the hadronic b quark 2
            parBhad3E,   ///< Energy of the hadronic b quark 3
            parBlepE,   ///< Energy of the leptonic b quark
            parLQ1E,    ///< Energy of the light quark 1
            parLQ2E,    ///< Energy of the light quark 2
            parLQ3E,    ///< Energy of the light quark 3
            parLQ4E,    ///< Energy of the light quark 4
            parLQ5E,    ///< Energy of the light quark 5
            parLQ6E,    ///< Energy of the light quark 6
    ...
    protected:
        ...
        double m_bhad1_meas_e;
        double m_bhad1_meas_p;
        double m_bhad1_meas_m;
        double m_bhad1_meas_deteta;
        double m_bhad1_meas_eta;
        double m_bhad1_meas_phi;
        double m_bhad1_meas_px;
        double m_bhad1_meas_py;
        double m_bhad1_meas_pz;

        double m_bhad2_meas_e;
        double m_bhad2_meas_p;
        double m_bhad2_meas_m;
        double m_bhad2_meas_deteta;
        double m_bhad2_meas_eta;
        double m_bhad2_meas_phi;
        double m_bhad2_meas_px;
        double m_bhad2_meas_py;
        double m_bhad2_meas_pz;

        double m_bhad3_meas_e;
        double m_bhad3_meas_p;
        double m_bhad3_meas_m;
        double m_bhad3_meas_deteta;
        double m_bhad3_meas_eta;
        double m_bhad3_meas_phi;
        double m_bhad3_meas_px;
        double m_bhad3_meas_py;
        double m_bhad3_meas_pz;
        ...
        double m_lq3_meas_p;
        double m_lq3_meas_m;
        double m_lq3_meas_deteta;
        double m_lq3_meas_eta;
        double m_lq3_meas_phi;
        double m_lq3_meas_px;
        double m_lq3_meas_py;
        double m_lq3_meas_pz;

        double m_lq4_meas_e;
        double m_lq4_meas_p;
        double m_lq4_meas_m;
        double m_lq4_meas_deteta;
        double m_lq4_meas_eta;
        double m_lq4_meas_phi;
        double m_lq4_meas_px;
        double m_lq4_meas_py;
        double m_lq4_meas_pz;

        double m_lq5_meas_e;
        double m_lq5_meas_p;
        double m_lq5_meas_m;
        double m_lq5_meas_deteta;
        double m_lq5_meas_eta;
        double m_lq5_meas_phi;
        double m_lq5_meas_px;
        double m_lq5_meas_py;
        double m_lq5_meas_pz;

        double m_lq6_meas_e;
        double m_lq6_meas_p;
        double m_lq6_meas_m;
        double m_lq6_meas_deteta;
        double m_lq6_meas_eta;
        double m_lq6_meas_phi;
        ...
        double m_bhad1_fit_e;
        double m_bhad1_fit_px;
        double m_bhad1_fit_py;
        double m_bhad1_fit_pz;

        double m_bhad2_fit_e;
        double m_bhad2_fit_px;
        double m_bhad2_fit_py;
        double m_bhad2_fit_pz;

        double m_bhad3_fit_e;
        ...
        double m_whad1_fit_e;
        double m_whad1_fit_px;
        double m_whad1_fit_py;
        double m_whad1_fit_pz;

        double m_whad2_fit_e;
        double m_whad2_fit_px;
        double m_whad2_fit_py;
        double m_whad2_fit_pz;

        double m_whad3_fit_e;
        double m_whad3_fit_px;
        double m_whad3_fit_py;
        double m_whad3_fit_pz;

        double m_whad1_fit_m;
        double m_whad2_fit_m;
        double m_whad3_fit_m;
        double m_wlep_fit_m;
        double m_thad1_fit_m;
        double m_thad2_fit_m;
        double m_thad3_fit_m;
        double m_tlep_fit_m;
...
#endif //KLFITTER_LIKELIHOODFOURTOPLEPTONJETS_H
